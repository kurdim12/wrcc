...
| 6 | "Detects 30–90 days before visible symptoms" | Early acoustic warning is the **core innovation**. The 30–90-day lead is a **design target grounded in RPW biology** (larvae feed inside the trunk weeks-to-months pre-symptom; ~12-day acoustic detectability — El-Sabea 2009; Sci. Rep. 2020), **not** a device-measured result. | ✅ Keep prominent, framed as a **cited design target / expected window** ("field validation will confirm the exact lead time"). Never as a measured device result. |
