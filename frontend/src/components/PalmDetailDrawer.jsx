...
// Vertical trunk silhouette with the device + a labelled "activity zone".
// Honest: this is an activity VISUALISATION, never exact larvae location.
const PalmCoreDiagram = ({ risk = 0 }) => {
